...
import 'package:grarr/module/repair/view/credit_cards2/credit_card2.dart';
...
class Add_Credit_Card2 extends StatefulWidget {
  const Add_Credit_Card2({super.key});

  @override
  State<Add_Credit_Card2> createState() => _Add_Credit_Card2State();
}

class _Add_Credit_Card2State extends State<Add_Credit_Card2> {
  @override
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Primary_Btn(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>Credit_Cards2()));
                },
                title: Text(
                  "Add Credit Card",
